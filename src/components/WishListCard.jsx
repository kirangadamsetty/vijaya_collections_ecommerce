...
<Card.Img variant="top" src={data.image} className = "product-image" style={{ height: "350px", objectFit: "cover", objectPosition:"top center"}} />
 ...
 <Button onClick = {(e) =>{e.stopPropagation(); handleCartList(data);handleCancelWishList(data); notifyAdded()}} className = "bg-white text-secondary  mt-2 w-100  custom-button2" style ={{fontSize:"13px"}}><img src = {cartIcon} width = "20" className = "me-2 mb-1 button-icon"/>ADD TO BAG</Button>
