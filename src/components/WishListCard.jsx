...
function WishListCard({data}) {
  ...
  return (
    <Card style={{ minWidth: '20rem',height:"100%", cursor:"pointer" }}>
      ...
      <p onClick = {() =>handleCancelWishList(data)} className = "shadow-lg text-dark d-flex justify-content-center align-items-center" style = {{right:"0",color:"white",position:"absolute", backgroundColor:"lightgray", width:"30px", height:"30px", margin:"4px 5px", borderRadius:"100%"}}><img src = {closeIcon} alt = "closeIcon" width = "20"/></p>
      <Card.Body>
